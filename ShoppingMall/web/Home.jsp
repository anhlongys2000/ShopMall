                        ...
                        <c:forEach items="${sessionScope.listb}" var="b">
                                ...
                                <div class="product col-12 col-md-6 col-lg-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title show_txt"><a href="detail?bid=${b.getRauID()}" title="View Rau"></a></h4>
                                            <p class="card-text show_txt">${b.getRauName()}</p>
                                            <div class="row">
                                                <div class="col">
                                                ...
                                                <c:if test="${sessionScope.USER.getRoleID() == 2}">
                                                    <c:if test="${b.getQuantity()>0}">
                                                        <div class="col">
                                                            <a href="MainController?action=AddtoCart&bid=${b.getRauID()}" class="btn btn-success btn-block">Add to cart</a>
                                                        </div>
                                                    </c:if>
                                                    <c:if test="${b.getQuantity()<=0}">
