...
<nav class="navbar navbar-expand-md bg-light">
        <a class="nav-link text-uppercase" href="#"> Welcome, ${sessionScope.USERNAME}</a>   
    <div class="container">
        <a class="navbar-brand text-uppercase" href="MainController?action=home"> VEGETABLE STORE</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <ul class="navbar-nav badge-light">
                <c:if test="${sessionScope.USER.getRoleID() == 1}">
                    <li class="nav-item">
                        <a class="nav-item text-uppercase" href="MainController?action=manager">Manager Vegetable</a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.USER != null}">

                    <li class="nav-item">
                        <a class="nav-link text-uppercase" href="MainController?action=History">History Order</a>
                    </li>
                    <li  class="nav-item">
                        <a></a>
                    </li>
